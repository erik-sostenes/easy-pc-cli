...
import "github.com/erik-sostenes/easy-pc-cli/internal/context/shared/domain/bus/query"
...
type (
	...
	OfferScraper interface {
		// Scraping method that receives a domain.offer with query selectors to search the data of an offer by scraping
		Scraping() error
	}
)
